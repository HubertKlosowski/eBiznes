...
<template>
  <div class="header">
    ...
    <div class="account" @click="account()">
  ...
  <div class="main">
<!--    <div class="about_us">EduLeaf to nowoczesna platforma edukacyjna oferująca korepetycje i kursy online dla uczniów szkół podstawowych i średnich. Łączymy najlepszych nauczycieli z technologią, aby zapewnić efektywną i elastyczną naukę.</div>-->
